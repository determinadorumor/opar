...
global_variables() {
    ...
    # Blog title
    global_title="Opiniones artesanales"
    # The typical subtitle for each blog
    # global_description="resplandecen a la altura de los ojos"
    # The public base URL for this blog
    global_url="http://opiniones.determinadorumor.com.ar/"

    # Your name
    global_author="Bombo"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="http://twitter.com/enjoydesilientio"
    # Your email
    global_email="bombo@determinadorumor.com.ar"
    ...
    global_twitter_username="enjoydesilentio"
